...
# Masque scanlines — généré une seule fois
...
def effet_hologramme(zone):
    ...
    # 3 — Aberration RGB — trois couches décalées indépendamment
    b, g, r = cv2.split(hologramme)
    b = decaler_canal(b,  12,  3, OEIL_W, OEIL_H)  # bleu — droite et bas
    g = decaler_canal(g,  -6, -2, OEIL_W, OEIL_H)  # vert — gauche et haut
    r = decaler_canal(r, -12,  5, OEIL_W, OEIL_H)  # rouge — gauche et bas
