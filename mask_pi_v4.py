    ...
    while True:
        ...
        if result.face_landmarks:
            ...
            if oeil_milena is not None:
                out_oeil = cv2.addWeighted(out_oeil, POIDS_FLUX, oeil_milena, POIDS_MILENA, 0)
            ...
            if bouche_milena is not None:
                out_bouche = cv2.addWeighted(out_bouche, POIDS_FLUX, bouche_milena, POIDS_MILENA, 0)
        else:
            # Aucun visage : Milena habite seule le masque
            if oeil_milena is not None:
                out_oeil = oeil_milena.copy()
            if bouche_milena is not None:
                out_bouche = bouche_milena.copy()
